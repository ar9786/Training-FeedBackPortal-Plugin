...
class PortfolioFeedbackActivate {
	static function activate(){
		...
		//$jal_db_version = '1.0';
		$table_name_trainers = $wpdb->prefix . 'lws_trainers';
	...
	//	add_option( 'jal_db_version', $jal_db_version );
		...
		$table_name_questions = $wpdb->prefix . 'lws_questions';
		...
		$table_name_questions = $wpdb->prefix . 'lws_departments';
		if($wpdb->get_var( "show tables like '$table_name_questions'" ) != $table_name_questions){
		$charset_collate = $wpdb->get_charset_collate();
		...
		$table_name_questions = $wpdb->prefix . 'lws_recordfeedbacks';
		if($wpdb->get_var( "show tables like '$table_name_questions'" ) != $table_name_questions){
		$charset_collate = $wpdb->get_charset_collate();
